...
public class PlayerStatsManager : NetworkBehaviour
{
    ...
    public void setPlayerTotalResources(int index, int amount) {
        switch (index)
      {
        case 0:
            ...
            totalResourceText0.text = amount.ToString();
            break;
        case 1:
            totalResource1 += amount;
            totalResourceText1.text = amount.ToString();
            break;
        case 2:
            totalResource2 += amount;
            totalResourceText2.text = amount.ToString();
            break;
        case 3:
            totalResource3 += amount;
            totalResourceText3.text = amount.ToString();
            break;
        default:
            Debug.Log("Invalid player index");
            break;
    ...
    public void setPlayerTotalSettlements(int index, int amount) {
        switch (index)
      {
        case 0:
            ...
            totalSettlementText0.text = amount.ToString();
            break;
        case 1:
            totalSettlement1 += amount;
            totalSettlementText1.text = amount.ToString();
            break;
        case 2:
            totalSettlement2 += amount;
            totalSettlementText2.text = amount.ToString();
            break;
        case 3:
            totalSettlement3 += amount;
            totalSettlementText3.text = amount.ToString();
            break;
        default:
            Debug.Log("Invalid player index");
            break;
    ...
    public void setPlayerTotalRoads(int index, int amount) {
        switch (index)
      {
        case 0:
            totalRoad0 += amount;
            totalRoadText0.text = amount.ToString();
            break;
        case 1:
            totalRoad1 += amount;
            totalRoadText1.text = amount.ToString();
            break;
        case 2:
            totalRoad2 += amount;
            totalRoadText2.text = amount.ToString();
            break;
        case 3:
            totalRoad3 += amount;
            totalRoadText3.text = amount.ToString();
            break;
        default:
            Debug.Log("Invalid player index");
            break;
